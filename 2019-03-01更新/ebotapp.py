...
class EbotSpider:
    ...
    # 解密函数(des解密)
    def decrypt(self, _0xa0c834):

        _0x554c90 = int(_0xa0c834[-1], 16) + 9  
        _0x2cf8ae = int(_0xa0c834[_0x554c90], 16)  

        _0xa0c834 = _0xa0c834[1:] if _0x554c90==0 else _0xa0c834[:_0x554c90]+_0xa0c834[_0x554c90+1:]

        _0x554c90 = _0xa0c834[_0x2cf8ae: _0x2cf8ae+8]
        ...
        k = des(key, mode, iv, pad=None, padmode=padding)
        decrypt_data = k.decrypt(ciphertext).decode('utf-8')
